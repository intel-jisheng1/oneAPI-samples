...
int main(int argc, char **argv) {
    ...
    std::ifstream hardwareData("/nfs/site/disks/swuser_work_jisheng1/hsd/14022200110_reduce/external/oneapi-src/oneAPI-samples/DirectProgramming/C++SYCL_FPGA/ReferenceDesigns/fft2d_shim_kernel/build/sim_shim_data2_0.txt"); 
    std::ifstream emuData("/nfs/site/disks/swuser_work_jisheng1/hsd/14022200110_reduce/external/oneapi-src/oneAPI-samples/DirectProgramming/C++SYCL_FPGA/ReferenceDesigns/fft2d_shim_kernel/build/emu_shim_data2_0.txt"); 
